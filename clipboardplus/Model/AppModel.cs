...
namespace clipboardplus
{
    public class AppModel : EntityBase
    {
        ...
        private double _MaskLeftWidth = YanaImageEditor.ScreenWidth;
        ...
        {
            sb.Clear();
            sb.Append((int)(YanaImageEditor.Current.MainImage.Width * YanaImageEditor.ScreenScale));
            sb.Append(" × ");
            sb.Append((int)(YanaImageEditor.Current.MainImage.Height * YanaImageEditor.ScreenScale));
