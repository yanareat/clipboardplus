...
namespace clipboardplus.Controls { 
    ...
    public class TextBoxControl : Control
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            _TextBox.MaxWidth = YanaImageEditor.Current.MainImage.Width - YanaImageEditor.Current.MainImage.point.X - 3;
            _TextBox.MaxHeight = YanaImageEditor.Current.MainImage.Height - YanaImageEditor.Current.MainImage.point.Y - 3;
        }
        ...
        protected void OnMyFocusValueChanged()
        {
            if (!MyFocus)
            {
                ...
                {
                    YanaImageEditor.RemoveControl(this);
                }
                else
                {
                    YanaImageEditor.Current.MainImage.ResetLimit(Canvas.GetLeft(this), Canvas.GetTop(this), (Canvas.GetLeft(this) + ActualWidth), (Canvas.GetTop(this) + ActualHeight));
                    YanaImageEditor.Register(this);
                }
                YanaImageEditor.Current.MainImage._Text = null;
            }
        }
        #endregion
    }
